...
export function ChessData() {
  ...
  return (
    <div className="chess-data">
      ...
      <XYPlot width={vw} height={400} yDomain={[1075, 1825]} margin={{ left: 40, right: 20, top: 10, bottom: 40 }}>
        <XAxis
        ...
        />
        <YAxis title="ELO" tickValues={[1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800]} tickFormat={(v) => parseInt(v)} />
        <HorizontalGridLines />
        <LineMarkSeries
          data={gameData}
