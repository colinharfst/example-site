    ...
    return (
      <svg className="signature" width="532" height="76" viewBox="0 0 532 76" fill="none">
        <g>
          ...
          <path d="m 358 8 l 0 60 10 0 0 -25 7.5 0 12.5 25 10 0 -15 -30 c 12 -6 25 -36 -25 -30 l -1 0 m 11 10 l 0 15 7.5 0 c 12 -6 15 -18 -7.5 -15 l -1 0" />
    ...
    return (
      <svg className="signature" width="286" height="160" viewBox="0 0 286 160" fill="none">
        <g>
          ...
          <path d="m 104 92 l 0 60 10 0 0 -25 7.5 0 12.5 25 10 0 -15 -30 c 12 -6 25 -36 -25 -30 l -1 0 m 11 10 l 0 15 7.5 0 c 12 -6 15 -18 -7.5 -15 l -1 0" />
